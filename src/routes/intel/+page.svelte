<script lang="ts">
  ...
  const products = [
    // R$1.190,00
    {
      title: "(PC0002) PC GAMER i5 de 3ª - R$1.190,00",
      image: "PC0002.png",
    ...
    // R$4.490,00
    {
      title: "(PC0052) i5 de 10ª + GTX 1650 4GB",
      image: "PC0052.png",
    ...
    // R$4.790,00
    {
      title: "(PC0051) i5 de 12ª + RX 570 8GB",
      image: "PC0051.png",
