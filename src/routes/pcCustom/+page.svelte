<script lang="ts">
  ...
  const products = [
    ...
    // R$ 5.390,00
    {
      title: "Nº2 - (PC0059) i5 de 12ªG + RX 580",
      image: "PC0059.png",
    ...
    // R$9.290,00
    {
      title: "Nº8 - (PC0083) PC GAMER I5-12400F + RTX 4060 8GB PYTHON",
